      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-3 cursor-pointer" onClick={() => setActiveTab('brief')}>
            <div className="w-10 h-10 rounded-xl bg-[#020408] border border-[#21262d] flex items-center justify-center">
            ...
            <div>
              <div className="flex items-center space-x-2">
                ...
                <span className="px-1.5 py-0.5 text-[12px] font-mono font-semibold bg-[#020408] text-zinc-400 border border-[#21262d] rounded">
                  ECE
                </span>
              </div>
          ...
          <nav className="flex items-center space-x-1 sm:space-x-2 bg-[#020408] p-1 rounded-lg border border-[#21262d]">
            <button
              id="nav-brief-tab"
              onClick={() => setActiveTab('brief')}
              className={`flex items-center space-x-2 px-3 py-1.5 rounded-md text-[14px] font-medium transition-all ${
                activeTab === 'brief'
          ...
          <div className="flex items-center space-x-3">
            <button
              ...
              className="hidden md:flex items-center space-x-1.5 bg-[#020408] hover:bg-[#161b22] text-zinc-200 text-[12px] font-semibold px-3 py-1.5 rounded-lg border border-[#21262d] transition"
            ...
            <div className="flex items-center space-x-2 pl-2 border-l border-[#21262d]">
              <div className="w-8 h-8 rounded-full bg-[#020408] border border-[#21262d] flex items-center justify-center text-[12px] font-bold text-zinc-200">
                {userName.charAt(0)}
              </div>
